...
def generate_from_rhino_view(image, prompt, pipeline=None, negative_prompt="ugly, low quality", 
    ...
    if pipe is None:
        raise ValueError("Pipeline is not loaded. Please initialize models first.")
...
#get an output image
captured_image = Image.open("C:\\Users\Hesham.Shawqy\Desktop\ViewCapture20240903_175704.jpg")
